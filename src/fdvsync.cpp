...
MTD_FLASHMEM MutexLock::MutexLock(Mutex *mutex, uint32_t msTimeOut) : m_mutex(mutex) {
...
MTD_FLASHMEM MutexLockFromISR::MutexLockFromISR(Mutex *mutex) : m_mutex(mutex) { m_acquired = m_mutex->lockFromISR(); }
